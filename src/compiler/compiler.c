...
ParseRule rules[] = {
    ...
    [TOKEN_OR]            = {NULL,     or_,   PREC_NONE},         //   or
...
static void function(FunctionType type) {
    ...
    emitBytes(OP_CONSTANT, makeConstant(OBJ_VAL(function))); // в чанк внешней ф-ии добавляем созданную
}
